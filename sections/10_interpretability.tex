...
Table~\ref{tab:interp_lomo_full} and Fig.~\ref{fig:interp_lomo_full} report
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.86\linewidth]{generated/aireadi_interp_lomo_full_attribution.pdf}
  \caption{%
    \textbf{Output-level LOMO attribution on the full held-out test split
    ($n=153{,}591$ anchors).}
    Bars show the mean absolute forecast change after ablating each modality.
    Glucose history dominates, static/context variables calibrate the decoder,
    and the meal-proxy diagnostic channel has no measurable output-level
    effect. %
  }
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.86\linewidth]{generated/aireadi_interp_h_t_rigorous.pdf}
  \caption{%
    \textbf{State-construction attribution by modality.}
