...
# =============================
def create_tft_dataloaders_static(train_df, param, extra_static_reals=None):
    """
...
def TFT_train_static(train_df, param, out_dir: Path, extra_static_reals=None):
    training, val_dl, train_dl, validation = create_tft_dataloaders_static(
        train_df, param, extra_static_reals=extra_static_reals
    )
...
if __name__ == "__main__":
    ...
    if args.eval_only:
        ...
        _, val_dl, _, _ = create_tft_dataloaders_static(train_df, param, extra_static_reals)
